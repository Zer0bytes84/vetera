...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border px-2 py-0.5 font-medium text-[0.72rem] tracking-normal transition-colors",
  {
    variants: {
      variant: {
        neutral:
          "border-[var(--border-color)] bg-[var(--surface-200)] text-[var(--text-secondary)]",
        success:
        ...
        danger:
          "border-transparent bg-rose-50 text-rose-700 dark:bg-rose-950/50 dark:text-rose-300",

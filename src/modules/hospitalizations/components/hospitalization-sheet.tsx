      ...
      >
        <SheetHeader className="border-b border-border/40 px-6 py-5 bg-background/50 backdrop-blur-md">
          <div className="flex items-center gap-3">
            <span className="flex size-10 items-center justify-center rounded-xl bg-gradient-to-br from-sky-500/20 to-sky-500/5 text-sky-600 shadow-sm border border-sky-500/10">
              <Hospital weight="duotone" className="size-5" />
            </span>
            <div>

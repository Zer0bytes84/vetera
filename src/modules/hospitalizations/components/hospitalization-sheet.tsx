      ...
      >
        <SheetHeader className="border-border/40 border-b bg-background/50 px-6 py-5 backdrop-blur-md">
          <div className="flex items-center gap-3">
            <span className="flex size-10 items-center justify-center rounded-xl border border-sky-500/10 bg-gradient-to-br from-sky-500/20 to-sky-500/5 text-sky-600 shadow-sm">
              <Hospital className="size-5" weight="duotone" />
            </span>
            <div>

              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className={cn(
                      "flex size-5 shrink-0 items-center justify-center rounded-lg border text-white transition-[transform,colors] duration-200 ease-[cubic-bezier(0.23,1,0.32,1)] cursor-pointer active:scale-[0.95]",
                      task.status === "done"
